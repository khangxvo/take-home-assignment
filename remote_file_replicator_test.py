...
class TestRemoteFileReplicator(unittest.TestCase):
    ...
    def _check_min_task_num(self, min_task_num: int):
        if _in_assessment_environment() and TASK_NUM < min_task_num:
            self.fail(
                f"Please set TASK_NUM >= {min_task_num} to run this test.")
    ...
    def _test_helper(self, config: Config):
        ...
        if config.non_empty_target_dir:
            ...
            target_fs.writefile(
                "/other/dir/sub_1/sub_1_1/file_1_1_1", "content_1_1_1")
            ...
            target_fs.writefile(
                "/other/dir/sub_3/sub_3_1/file_3_1_1", "content_3_1_1")
        ...
        if config.unrelated_dirs:
            ...
            self.assertTrue(file_system_dirs_equal(
                ref_source_fs_dirs_unrelated))
        ...
        def check_correctness(expected_num_watched_dirs: int, expected_num_writes: int):
            ...
            if config.non_empty_target_dir and config.avoid_redundant_writes:
                self.assertEqual(
                    expected_num_writes,
                    target_fs.get_num_operations(
                        "writefile") - initial_num_writes,
                )
        ...
        source_fs.handle_event(
            FileSystemEvent(
                "/base/sub_3", FileSystemEventType.FILE_OR_SUBDIR_ADDED),
        )
        ...
        # Modify file.
        source_fs.writefile(
            "/base/sub_3/sub_3_1/file_3_1_1", "content_3_1_1_v2")
        source_fs.handle_event(
            FileSystemEvent(
